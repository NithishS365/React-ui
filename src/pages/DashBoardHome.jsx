      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6  ">
        ...
        <div class="bg-white rounded-xl shadow p-6 h-fit">
          <div class="flex justify-between items-center mb-2">
            ...
            <div class="text-sm text-gray-500">Graph View</div>
          </div>
          <h2 class="text-xl font-bold">Rs. 200,000</h2>
          <p class="text-green-600 text-sm mt-1">✔ On track of this area</p>
          <div class="h-40 bg-blue-100 mt-4 rounded-xl flex items-center justify-center text-gray-500">
            <LineChart />
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow p-6 h-fit">
          <div class="flex justify-between items-center mb-2">
            <h3 class="text-lg font-semibold">Payment Analysis</h3>
            <div class="text-sm text-gray-500">Monthly</div>

          </div>
          <PieChart className="h-100" />
        </div>
        <p class="text-center text-sm text-gray-600 mt-2">Payments Done </p>
      </div>
